...
public:
	void AppendChildNode(const XmlNode& new_child);
	...
	bool InsertChildNode(const XmlNode& new_child, size_t index);
	bool InsertChildNode(const XmlNode& new_child, const XmlNode& ref_child);
